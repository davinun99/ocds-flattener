...
SELECT
	...
	data['compiledRelease']['complaints'] as "complaints", --72
	COALESCE(jsonb_array_length(data['compiledRelease']['complaints']), 0) as "complaints.count" --73
FROM RECORD r join data d on d.id = r.data_id 
	...
	print(';;;planning.items.classification.id.n4;;;planning.items.classification.id.n3;;;planning.items.classification.id.n2;;;planning.items.classification.id.n1;;;planning.items.classification.id.n1_1;;;has_complaint')
