...
FROM RECORD r join data d on d.id = r.data_id LIMIT 500
	...
	print(';;;contracts.value.amount_pyg;;;contracts.value.amount_usd;;;contracts.status;;;contracts.statusDetails;;;awards.documents.DocumentTypeDetails;;;awards.suppliers.id q1;;;awards.suppliers.id q2;;;awards.suppliers.id q3;;;awards.suppliers.id q4;;;awards.value.amount_pyg;;;awards.value.amount_usd', end='')
	print(';;;awards.status;;;awards.statusDetails;;;tender.coveredBy;;;tender.notifiedSuppliers.id q1;;;tender.notifiedSuppliers.id q2;;;tender.notifiedSuppliers.id q3;;;tender.notifiedSuppliers.id q4;;;tender.tenderers.id q1;;;tender.tenderers.id q2;;;tender.tenderers.id q3;;;tender.tenderers.id q4', end='')
