...
FROM RECORD r join data d on d.id = r.data_id
	...
	print(obtain_column_names(';;;contracts.guarantees.obligations',18)+obtain_column_names(';;;contracts.investmentProjects.id',153)+';;;contracts.amendments.amendsAmount_pyg;;;contracts.amendments.amendsAmount_usd;;;contracts.amendments.count;;;contracts.implementation.purchaseOrders.count;;;contracts.implementation.transactions.count'+obtain_column_names(';;;contracts.documents.DocumentTypeDetails',8), end='')
	print(';;;contracts.value.amount_pyg;;;contracts.value.amount_usd'+obtain_column_names(';;;contracts.status',4)+obtain_column_names(';;;contracts.statusDetails',7)+obtain_column_names(';;;awards.documents.DocumentTypeDetails',17)+';;;awards.suppliers.id q1;;;awards.suppliers.id q2;;;awards.suppliers.id q3;;;awards.suppliers.id q4;;;awards.value.amount_pyg;;;awards.value.amount_usd', end='')
